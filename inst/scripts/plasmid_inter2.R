...
write.table(good_table, paste(dir, "/reliable_clones_", DIs, "_", ratio, ".csv", sep = ""), sep = ",")
write.table(swaps, paste(dir, "/reliable_clones_swaps_", DIs, "_", ratio, ".csv", sep = ""), sep = ",")
write.table(correct, paste(dir, "/reliable_clones_confirmations_", DIs, "_", ratio, ".csv", sep = ""), sep = ",")
...
if (is.null(clones) == F) {
  ...
  write.table(good_table, paste(dir, "/reliable_clones_ofint.csv", sep = ""), sep = ",")
  write.table(swaps, paste(dir, "/reliable_clones_swaps_ofint.csv", sep = ""), sep = ",")
  write.table(correct, paste(dir, "/reliable_clones_confirmations_ofint.csv", sep = ""), sep = ",")
